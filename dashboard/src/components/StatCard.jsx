...
export default function StatCard({ title, value, label, icon, color = 'blue', sublabel }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -2, boxShadow: 'var(--card-glass-shadow), inset 0 1px 0 rgba(255,255,255,0.1), 0 8px 32px rgba(0,0,0,0.1)' }}
    ...
    >
      <div className="card-header" style={{ marginBottom: 12 }}>
        ...
        <span className="card-icon" style={{ 
          ...
          filter: `drop-shadow(0 0 12px ${colorMap[color]}66)`,
      ...
      <div style={{ fontSize: 36, fontWeight: 900, lineHeight: 1, marginBottom: 6, fontVariantNumeric: 'tabular-nums', color: 'var(--text-primary)', textShadow: `0 0 24px ${colorMap[color]}66` }}>
